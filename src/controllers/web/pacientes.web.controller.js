...
class PacientesWebController {
    async listPacientes(req, res) {
        try{
            ...
            res.render('ejs/pacientes/list', {pacientes: pacientesLista, title: 'Listado de Pacientes'});
        }catch(error){
    ...
    async showNuevoPacienteForm(req, res) {
        res.render('ejs/pacientes/new', { title: 'Registrar nuevo paciente' });
    }
    ...
    async showEditarPacienteForm(req, res) {
        ...
        try{
            ...
            res.render('ejs/pacientes/edit', { paciente: paciente, title: 'Editar Paciente' });
        } catch(error){
    ...
    async darBajaPaciente(req, res) {
        ...
        try{
            ...
            res.redirect('/pacientes?mensaje=Paciente%20eliminado%20correctamente');
                ...
                return res.status(404).render('error',{message:'Paciente ${numericoIdPaciente} no encontrado'});
            }
        } catch(error){
